	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="积分" prop="jifen">
					<el-input v-model="ruleForm.jifen" placeholder="积分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="增加时间" prop="zengjiashijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.zengjiashijian" label="增加时间" prop="zengjiashijian">
					<el-input v-model="ruleForm.zengjiashijian" placeholder="增加时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="增加事由" prop="zengjiashiyou">
					<el-input v-model="ruleForm.zengjiashiyou" placeholder="增加事由" clearable  :readonly="ro.zengjiashiyou"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="增加事由" prop="zengjiashiyou">
					<el-input v-model="ruleForm.zengjiashiyou" placeholder="增加事由" readonly></el-input>
				</el-form-item>
			</template>
