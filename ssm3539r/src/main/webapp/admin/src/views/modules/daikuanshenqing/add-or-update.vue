	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="身份证" prop="shenfenzheng">
					<el-input v-model="ruleForm.shenfenzheng" placeholder="身份证" clearable  :readonly="ro.shenfenzheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="身份证" prop="shenfenzheng">
					<el-input v-model="ruleForm.shenfenzheng" placeholder="身份证" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="贷款金额" prop="daikuanjine">
					<el-input v-model="ruleForm.daikuanjine" placeholder="贷款金额" clearable  :readonly="ro.daikuanjine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="贷款金额" prop="daikuanjine">
					<el-input v-model="ruleForm.daikuanjine" placeholder="贷款金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="贷款时间" prop="daikuanshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.daikuanshijian" 
						type="datetime"
						:readonly="ro.daikuanshijian"
						placeholder="贷款时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.daikuanshijian" label="贷款时间" prop="daikuanshijian">
					<el-input v-model="ruleForm.daikuanshijian" placeholder="贷款时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="textarea" v-if="type!='info'" label="贷款说明" prop="daikuanshuoming">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="贷款说明"
					  v-model="ruleForm.daikuanshuoming" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else-if="ruleForm.daikuanshuoming" label="贷款说明" prop="daikuanshuoming">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.daikuanshuoming}}</span>
				</el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				...
				shenfenzheng : false,
				daikuanjine : false,
				daikuanshijian : false,
				daikuanshuoming : false,
				sfsh : false,
				shhf : false,
			},
	...
	created() {
		this.ruleForm.daikuanshijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='daikuanshijian'){
							this.ruleForm.daikuanshijian = obj[o];
							this.ro.daikuanshijian = true;
							continue;
						}
						if(o=='daikuanshuoming'){
							this.ruleForm.daikuanshuoming = obj[o];
							this.ro.daikuanshuoming = true;
							continue;
						}
				}
