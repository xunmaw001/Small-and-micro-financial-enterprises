	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discussdaikuanxinxi`, this.ruleForm.id);
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`discussdaikuanxinxi`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`discussdaikuanxinxi`, this.ruleForm);
						}else{
							await this.$api.add(`discussdaikuanxinxi`, this.ruleForm);
						}
						uni.setStorageSync('discussdaikuanxinxiCleanType',true);
